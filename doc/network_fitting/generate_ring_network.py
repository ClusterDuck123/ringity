...
def main():
    parser = argparse.ArgumentParser(description="Generate a 1D ring-like network and export data.")
    parser.add_argument('--type', type=str, default='model_network',
    ...
    parser.add_argument('--k', type=int, default=4, help="Each node is joined with its k nearest neighbors.")
    parser.add_argument('--p', type=float, default=0.1, help="Rewiring probability.")
    parser.add_argument('--beta', type=float, default=0.9, help="Each node is joined with its k nearest neighbors.")
    ...
    parser.add_argument('--gml', type=str, default="test.gml", help="Path to output GML file.")
    parser.add_argument('--csv', type=str, default="test.csv", help="Path to output CSV file for node positions.")
