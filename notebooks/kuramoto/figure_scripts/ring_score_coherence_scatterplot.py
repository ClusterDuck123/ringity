...
def main(args):
    ...
    print(df.columns)
    scatter_info = df.groupby("network_folder")[["ring_score","run_terminal_mean","beta","r","c"]].mean()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--i", type=str, default="data/parameter_array_csv/acd72081-919f-4386-a812-35d5b0b7f15d.csv", help="")
    parser.add_argument("--o", type=str, default="figures/scatterplot/ring_score_coherence_scatterplot.svg", help="")
