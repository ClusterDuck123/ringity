...
do
   for network_folder in $(ls data/parameter_array/);
    do echo iteraction $i of  "python run_kuramoto.py --i data/parameter_array/$network_folder --summary-info-file data/parameter_array_summary.csv --only-summary True"
