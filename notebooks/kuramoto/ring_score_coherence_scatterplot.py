...
def main(args):
    ...
    print(df)
    print(df.columns)
    scatter_info = df.groupby("network_folder")[["ring_score","terminal_mean","beta","r","c"]].mean()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--i", type=str, default="data/parameter_array_summary.csv", help="")
    parser.add_argument("--o", type=str, default="figures/ring_score_coherence_scatterplot.png", help="")
