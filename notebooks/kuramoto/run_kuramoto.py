...
def main():
    ...
    parser.add_argument("--quiet", type=bool, default=False, help="save minimal information, not enough to re-run the calculation") 
    ...
    if not args.only_summary:
        ...
        print("saved info to ", input_folder, "/runs/", run.run_id, "quiet ", args.quiet, "verbose", args.verbose)
