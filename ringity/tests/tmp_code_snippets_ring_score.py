...
print(f"Ring-score of cell-cycle genes: {cc_ring_score1:.3f}")
print(f"Ring-score of random genes    : {rand_ring_score1:.3f}")

print()

print(f"Ring-score of cell-cycle genes: {cc_ring_score2:.3f}")
print(f"Ring-score of random genes    : {rand_ring_score2:.3f}")
