...
def two_adjacent_circles(N, r=1, noise=0, seed=None):
...
def circle(N, noise=0, seed=None):
...
def vonmises_circles(N, kappa, noise=0, seed=None):
...
def sinoidal_trajectory(N, shift, noise=0, seed=None):
    """Generates sample points of a 2-dimensional \
...
def cylinder(N, height, noise=0, seed=None):
...
def torus(N, r, noise=0, seed=None):
    """Generates sample points of a cylinder in 3D \
...
# ===============================================================
def box(N, dim=2, noise=0, seed=None):
...
def sphere(N, dim=2, noise=0, seed=None):
