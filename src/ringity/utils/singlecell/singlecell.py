...
def ring_score_from_anndata(
    adata, var_names=None, obs_names=None, flavour="geometric", base=None
):
    ...
    score = rng.ring_score_from_point_cloud(
        X,
